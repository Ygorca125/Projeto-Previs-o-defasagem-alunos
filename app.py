...
if st.button("Calcular Probabilidade de Risco", type="primary"):
    ...
    # Criar os dados na mesma ordem e com os mesmos nomes que o modelo espera
    dados = pd.DataFrame([[
    ...
    # Garantir que as colunas estão exatamente na ordem que o modelo espera
    dados = dados[modelo.feature_names_in_]
    ...
    st.caption("Threshold utilizado: 0.40")